...
function removeDiacritics(text) {
  ...
  return text.split('').map(char => 
    vietnameseDiacriticMap[char] || char
  ).join('');
}
...
function createSearchPatterns(searchTerm) {
  ...
  console.log('Creating search patterns for:', searchTerm); // Debug
  console.log('Normalized term:', normalizedTerm); // Debug
  console.log('Original term:', originalTerm); // Debug
  ...
  flexiblePattern = flexiblePattern.split('').map(char => {
  ...
  console.log('All patterns:', patterns); // Debug
...
function createVietnameseSearchFilter(searchTerm, fields = ['title', 'description']) {
  ...
  console.log('Creating search filter for fields:', fields); // Debug
  ...
  console.log('Search conditions:', searchConditions); // Debug
